...
param(
    ...
    [ValidateSet('none', 'antigravity', 'codex', 'claudecode', 'copilot', 'geminicli', 'cursor', 'windsurf')]
...
$connectorIndices = @{ none = 0; antigravity = 1; codex = 2; claudecode = 3; copilot = 4; geminicli = 5; cursor = 6; windsurf = 7 }
