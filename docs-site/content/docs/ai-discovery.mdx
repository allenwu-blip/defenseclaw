...
| --- | --- |
| `supported_connector` | OpenClaw, ZeptoClaw, Claude Code, Codex, Cursor, Devin Desktop legacy Cascade, Gemini CLI, GitHub Copilot CLI, OpenHands, Antigravity, Hermes, OpenCode, OmniGent |
