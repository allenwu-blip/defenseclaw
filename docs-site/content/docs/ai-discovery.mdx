...
Claude Code, Codex, Cursor, Devin Desktop legacy Cascade, GitHub Copilot CLI,
...
| --- | --- |
| `supported_connector` | OpenClaw, ZeptoClaw, Claude Code, Codex, Cursor, Devin Desktop legacy Cascade, GitHub Copilot CLI, OpenHands, Antigravity, Hermes, OpenCode, Amp, OmniGent |
