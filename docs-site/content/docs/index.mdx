...
<Cards>
  <Card title="13 connectors" href="/docs/connectors" description="OpenClaw, ZeptoClaw, Claude Code, Codex, Cursor, Devin Desktop legacy Cascade, Gemini CLI, GitHub Copilot CLI, OpenHands, Antigravity, Hermes, OpenCode, OmniGent. The retained windsurf alias is Cascade-only." />
