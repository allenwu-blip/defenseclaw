...
| `defenseclaw setup cursor` | Preview user-hook alias for Cursor; remains advisory and downgrades action, fail-closed, and HITL requests to observe/fail-open/approval-disabled. |
