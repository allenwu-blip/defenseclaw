...
certified on native Windows. The Windows release currently certifies Claude
Code; Codex and OpenCode remain preview until their integrated gates pass. See the
