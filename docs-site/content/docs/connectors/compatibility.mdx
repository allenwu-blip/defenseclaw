...
| <ConnectorLabel id="geminicli" /> | hook contract | `>=0.26.0` (continuing enterprise/Google Cloud/paid API-key product only) | `geminicli-hooks-v1` / `v7` | prompt, tool_call, tool_result |
