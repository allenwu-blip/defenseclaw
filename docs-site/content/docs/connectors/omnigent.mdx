...
The preview currently covers packaged CLI setup, restart reconciliation,
Doctor, connector teardown, and clean-state verification. It is not evidence
that the Windows Setup executable's installer-driven repair, upgrade, or
deferred-uninstall transaction has qualified OmniGent; those shared installer
paths remain part of the later integrated validation and promotion gate.
