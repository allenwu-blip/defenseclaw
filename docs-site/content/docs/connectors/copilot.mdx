...
The teardown removes `$COPILOT_HOME/hooks/defenseclaw.json` (default `~/.copilot/hooks/defenseclaw.json`) or the pinned workspace hook file and leaves any other hook files in the directory untouched.
