...
DefenseClaw's shared contract accepts `>=1.1.8`; macOS remains preview and a
later release still requires the normal contract-drift review before it can be
treated as validated on that platform.
