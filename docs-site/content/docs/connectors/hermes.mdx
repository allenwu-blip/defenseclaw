...
support remains **preview / not certified / live: false** pending reload and
packaged real-client validation.
...
upgrade guidance. The latest official release rechecked on 2026-07-31 is
v0.19.1 (`v2026.7.30`); its source retains the reviewed v0.19 shell-hook
contract, but that source review is not packaged or real-client certification.
